...
describe('tileUtils', () => {
  describe('getTileImagePath', () => {
    it('should return fake okey path if isJoker is true', () => {
      ...
      expect(getTileImagePath(tile)).toBe('/src/assets/images/tiles/FakeOkey.png');
    });
    ...
    it('should return correct path based on color and number', () => {
      ...
      // 2 -> Blue
      expect(getTileImagePath(tile)).toBe('/src/assets/images/tiles/Blue_5.png');
    });
    ...
    it('should default to Red if color is unknown (though unusual)', () => {
       ...
       expect(getTileImagePath(tile)).toBe('/src/assets/images/tiles/Red_5.png');
    });
  });
